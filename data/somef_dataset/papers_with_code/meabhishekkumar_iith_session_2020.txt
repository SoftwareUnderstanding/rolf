...
1. Slides [ PDF : https://github.com/meabhishekkumar/iith_session_2020/blob/master/deep_learning_based_search_and_recommender_system.pdf ]
2. Notebooks
...
```sh
$ docker run -it --rm -p 8888:8888 -p 0.0.0.0:6006:6006 meabhishekkumar/strata-ca-2018:v1
```
