# Edits by Lucas Makinen
Modified the below to capture network performance in the presence of noisy test and training data to motivate an error bound in the event of uncertain graph data.
