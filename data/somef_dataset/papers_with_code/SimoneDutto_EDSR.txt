**Additions for our project**
  * We add several new loss [loss](https://github.com/SimoneDutto/EDSR/tree/master/src/loss) functions.
  * We add the capability to train and test on Google SVNH.
  * A Jupyter notebook [notebook](https://github.com/SimoneDutto/EDSR/blob/master/EDSR_notebook.ipynb) to run the new code.
