# faster-rcnn-tf
This repository had been edited by Xueqian Zhang, an edition to transformat video into picture. 

You can use this project to train infrared image set or other customized sets. **Note**: the image-set provided by this project can be downloaded from [here](https://github.com/zxqcreations/ImageSet.git).

This repository is based on the project of Xinlei Chen (xinleic@cs.cmu.edu),
