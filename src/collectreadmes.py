...
class ReadmeCollector:
	...
	def __getReadmeUrlFromGithubUrl(self, github_url: str) -> str:
		"""
			...
			@param github_url: (str) The github url.
			@return: (str) The url of the readme file.
		"""
	...
	def __getReadmeText(self, github_url: str) -> Union[str, None]:
		"""
			...
			@param github_url: (str) The github url.
			@return: (str) The text of the readme or None if not found.
		"""
	...
	def __downloadReadmeTextToFile(self, github_url: str, folder: Path) -> None:
		"""
			...
			@param github_url: (str) The github url.
			@param folder: (str) Path to the folder where readme text will be saved.
		"""
	...
	def getRepoNameFromGitHubUrl(self, url: str) -> str:
		"""
			...
			@param url: (str) The url to generate the name from.
			@return: (str) The generated repository name.
		"""
	...
	def addCategory(self, category: str, links: Iterable[str]) -> None:
		"""
			...
			@param links: (iterable[str]) Links to add to category
		"""
	...
	def addCategoriesFromCsvFile(self, path: str, delimiter: str = ';') -> None:
		"""
			...
			@param path: (str) Path to the csv file containing the data with 'Label', 'Repo' headers
				Examples: 'data/awesome_lists_links/awesome_lists.csv', 'data/awesome_lists_links/repos.csv'.
			@param delimiter: (str) Delimiter of the csv file.
		"""
	...
	def __collectGithubUrlsFromAwesomeList(self, input_url: str) -> Set[str]:
		"""
			...
			@param input_url: (str) The url where the github urls will be collected from.
			@return: (Set[str]) Set of the github urls collected.
		"""
		github_urls = set()
	...
	def downloadReadmeFiles(self, readmes_folder: str) -> None:
		"""
			...
			@param readmes_folder: (str) Path to the folder where the readmes will be saved.
	...
	def dumpGithubLinks(self, outfile: str) -> None:
		"""
			...
			@param outfile: (str) Path to the file where links will be dumped.
	...
	def createDatabase(self, outfolder: str, readmes_folder: str) -> None:
		"""
			...
			@param outfolder: (str) The folder where the databases are stored per category folders.
				Example: 'data/new datasets'
			@param readmes_folder: (str) Path to the folder where readmes are stored in separate folders per category.
				Example: 'data/awesome_lists_links/readme'
		"""
