...
### training, rendering
```
$ python train.py --load results/path-to-model [--env env-id] [--render]
```
example
```
$ python train.py --load results/breakout/model.ckpt-0 --env BreakoutNoFrameskip-v4 --render
```

### <span style="color:red">rendering without training, (using saved model instead )</span>
```
$ python train.py --demo --load results/path-to-model [--env env-id] [--render]
```
example
```
$ python train.py --demo --load results/breakout/model.ckpt-0 --env BreakoutNoFrameskip-v4 --render
```
